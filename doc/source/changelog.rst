  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Fix Linux installation discovery for \`~/ansys_inc\` and \`AWP_ROOTXXX\`
          - `#384 <https://github.com/ansys/ansys-tools-common/pull/384>`_
  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Feat: update extracting version from path
          - `#201 <https://github.com/ansys/ansys-tools-common/pull/201>`_
...
.. tab-set::
  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - [pre-commit.ci] pre-commit autoupdate
          - `#155 <https://github.com/ansys/ansys-tools-common/pull/155>`_
